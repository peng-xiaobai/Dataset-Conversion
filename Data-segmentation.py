...
if __name__ == '__main__':
	file_path = r"E:\peanut_data\JPEGImages"  # 图片文件夹
	label_path = r'E:\peanut_data\Annotations'  # 标签文件夹
	new_file_path = r"f:\VOCdevkit"  # 新数据存放位置
	split_data(file_path, label_path, new_file_path, train_rate=0.8, val_rate=0.1, test_rate=0.1) #训练集 验证集 测试集比例
